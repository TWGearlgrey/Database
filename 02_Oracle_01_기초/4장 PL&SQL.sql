...
/**
     변수 선언과 대입
        - 변수(Variable)는 데이터를 일시적으로 저장하고 
            상수(Constant)는 한번 저장된 값을 고정하는 문법 요소
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('부서주소 : ' || ROW_DEPT.LOC);
END;
...
--> WHERE 1=0은 false이므로 테이블 구조만 복사함
...
/**
    2. 반복문
        ...
        - PL/SQL는 LOOP, FOR LOOP, WHILE LOOP 제공
*/
// 실습 3-5. 기본 LOOP 실습
DECLARE
    NUM NUMBER := 0;
...
/**
    2. 예외처리
     ...
     - PL/SQL이 실행되는 도중 발생하는 오류를 처리하기 위해 예외처리(Exception) 수행
*/
-- 실습 4-4. 기본 예외처리 실습
DECLARE
    v_wrong NUMBER;
